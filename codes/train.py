...
def train_experiment(epochs: int = 80,
    ...
    """prepare for saving and log"""
    save_path_loss = r'/data/xuxin/ImageTBAD_processed/training_files/experiment/datalist/AD_2/UNet_cut_flip_dice_loss_2.pth'
    save_path_acc = r'/data/xuxin/ImageTBAD_processed/training_files/experiment/datalist/AD_2/UNet_cut_flip_dice_acc_2.pth'
    log = open(r'/data/xuxin/ImageTBAD_processed/training_files/experiment/datalist/AD_2/train_log_cut_flip_dice_2.txt', "a+", buffering=1)
    train_steps = len(train_loader)
    val_steps = len(validate_loader)
    least_loss = 999999999
    accuracy =  -1
