...
class MainWidget(QWidget):
    ...
    def __InitData(self):
        ...
        print(self.device)
        self.segment_model_path = r'/data/xuxin/ImageTBAD_processed/training_files/two_class/bothkinds_masks/transform_sobel_scribble/U_Net_transform_sobel_scribble_loss_20.pth'
    ...
    def Load(self):
        ...
        if file_name[0] is not None and file_name[0] != "":
            ...
            self.depth_slider.setValue(self.interact_image.depth_current)
