...
class MainWidget(QWidget):
    ...
    def __InitData(self):
        ...
        print(self.device)
        self.segment_model_path = r'/data/xuxin/ImageTBAD_processed/training_files/two_class/bothkinds_masks/transform_sobel_scribble/U_Net_transform_sobel_scribble_acc_15.pth'
